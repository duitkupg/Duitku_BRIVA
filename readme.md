...
## Install Duitku BRIVA plugins through Composer
...
1. Install the plugins: `composer require duitku_payment_gateway/duitku_briva`
2. Enable the plugin:  `bin/magento module:enable Duitku_BRIVA`
...
6. Check the module status:  `bin/magento module:status Duitku_BRIVA`
...
## Install Duitku BRIVA plugins from Download file
...
5. Run this command on terminal
    ...
    `bin/magento module:status Duitku_BRIVA`


# Plugin Usage Instruction
## Basic Plugins Configuration

Before you begin, make sure that you have successfully installed and enabled Duitku BRIVA plugins.
Configure the Duitku BRIVA plugin in your Magento admin panel: 
...
4. In the Other Payment Method section, click Duitku BRIVA to extend Basic Settings and fill out the following fields:
